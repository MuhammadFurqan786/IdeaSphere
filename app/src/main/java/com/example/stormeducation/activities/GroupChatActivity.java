...
import com.example.stormeducation.adapters.GroupAdapter;
import com.example.stormeducation.models.GroupMessage;
...
public class GroupChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userRef = FirebaseDatabase.getInstance().getReference(Constants.USER);
        groupNameRef = FirebaseDatabase.getInstance().getReference().child("Groups").child(currentGroupName);


        InitializeFields();
        currentUserName = Utilities.getString(getApplicationContext(),"username");
